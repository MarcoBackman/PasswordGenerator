 ...
 * Impact area - class is called from : PassGen.ui.dialog.SettingDialog;
 *             ---------- class calls :
 *
 */
...
public class SettingDialog extends JDialog implements ActionListener {
	...
	WarningMessage waning = new WarningMessage();

	//JTextField keyLenTextField;

	public SettingDialog(JFrame frame) {
		super((Frame)frame, "Setting", Dialog.ModalityType.DOCUMENT_MODAL);
