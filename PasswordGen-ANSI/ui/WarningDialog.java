...
import PassGen.calculation.Generate;
...
class WarningDialog  {
	...
	public void spaceCheckBoxWarning(JFrame frame) {
		ErrorDialog warningFrame = new ErrorDialog(frame, "Only spacing password is unavailable.");
	}
	...
	private class CheckDialog extends JDialog implements ActionListener {
		final int WIDTH = 200;
		final int HEIGHT = 200;
